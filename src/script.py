...
accuracy_lgbm = accuracy_score(y_test, predictions_lgbm_class)
...
accuracy_xgb = accuracy_score(y_test, predictions_xgb_class)
...
accuracy_catboost = accuracy_score(y_test, predictions_catboost_class)
